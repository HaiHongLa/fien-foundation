            ...
            <div class="row">
              <div class="col-xs-12 col-md-6">
                ...
                <div className="section-text2">
                    <p>We operate in Tanzania Mainland, East Africa, and our headquarters are in Morogoro Municipality. The organization started as an initiative in 2015, and officially was registered as a non-government organization in August 2019 with a registration number 00NGO/R/0323</p>
                </div>
              </div>
              <div class="col-xs-12 col-md-6">
                <iframe
